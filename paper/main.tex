...
operational data available to a forecaster. A separate common-history
sensitivity runner is included for reviewer checks, but the present
confirmatory claims use the completed five-station primary run.
...
and KC1 contains an instrument transition. The common-history sensitivity code
is included to examine this issue, but only completed primary results are used
...
neural forecaster safer and more competitive.
